        ...
        <View style={styles.container}>
          ...
          <View style={styles.propsContainer}>
            <View style={styles.propsItem}>
              ...
              <Text style={styles.propsText}>{data.meta?.rating ?? '0.0'}</Text>
            </View>
            <View style={styles.propsItem}>
            ...
            <View style={{ ...styles.accessView, borderColor: colors.success }}>
              <Text style={{ ...fonts.medium, color: colors.success }}>
          ...
          <Text style={typography.h4}>Syllabus</Text>
          <Spacer orientation="vertical" spacing={12} />
          ...
          <Text style={typography.h4}>Authors</Text>
          <Spacer orientation="vertical" spacing={12} />
